...
global.owner = process.env.OWNER_NUMBER || "237695942144"; // owner number 
global.sudo = process.env.SUDO  || " ";
global.ownername = process.env.OWNER_NAME || "Maldov"; //set bot owner name here 
global.botname = process.env.BOT_NAME || "MALBOT";
global.author = process.env.AUTHOR  || "Maldov";
global.packname = process.env.PACK_NAME  || "Maldov Md ²⁵";
...
global.session = process.env.SESSION_ID || "Arch_4e30853caf93502cb5adffef6678da3b";
